                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    ...
                                    <li class="breadcrumb-item"><a>Kategori</a>
                                    </li>
                                </ol>
                            </nav>
                        </div>
              ...
              <div class="col-lg-12 mb-4 mb-lg-0">
                <div class="card">
                  <div class="card-header">
                    <h2 class="h6 text-uppercase mb-0">Data Kategori</h2>
                  </div>
                  <div class="card-body">
                  	<a href="{{ route('kategori.create') }}" class="btn btn-success btn-sm">Tambah</a><br><br>
                        ...
                        <tbody>
                          ...
                          @foreach ($kategori as $result => $hasil)
            							<tr>
            								...
            								<td>
            									<a href="{{ route('kategori.edit', $hasil->id ) }}" class="btn btn-primary btn-sm">Edit</a>
    ...
    $(document).ready( function () {
        ...
        $('.delete').click(function(){
          ...
          .then((willDelete) => {
            if (willDelete) {
              if (willDelete) {
                window.location = "kategori/"+id+"/delete"
              }
              }
          });
        });
