...
Route::get('/list-kategori/{kategori}','Admin\BlogController@list_kategori')->name('blog.kategori');
Route::get('/list-tag/{tag}','Admin\BlogController@list_tag')->name('blog.tag');
Route::get('/list-user/{user}','Admin\BlogController@list_user')->name('blog.user');
